...
namespace Arcade2048.Middleware;
...
{ 
    public static void ConfigureProblemDetails(ProblemDetailsOptions options)
    {
        ...
        options.MapToStatusCode<ForbiddenAccessException>(StatusCodes.Status403Forbidden);
    ...
    private static void MapValidationException(this ProblemDetailsOptions options) =>
        options.Map<ValidationException>((ctx, ex) =>
        {
            ...
            return factory.CreateValidationProblemDetails(ctx, ex.Errors, StatusCodes.Status400BadRequest);
        });
}
