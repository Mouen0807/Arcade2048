...
public class TestingServiceScope 
{
    ...
    public async Task<TEntity> FindAsync<TEntity>(params object[] keyValues)
        where TEntity : class
    {
        var context = _scope.ServiceProvider.GetService<Arcade2048DbContext>();
    ...
    {
        var dbContext = _scope.ServiceProvider.GetRequiredService<Arcade2048DbContext>();
    ...
    public Task<T> ExecuteDbContextAsync<T>(Func<Arcade2048DbContext, Task<T>> action)
