...
using Xunit;
using static Resources.Arcade2048Options;
...
public class TestFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        builder.Configuration.GetSection(ConnectionStringOptions.SectionName)[ConnectionStringOptions.Arcade2048Key] = connection;
    ...
    {
        var options = new DbContextOptionsBuilder<Arcade2048DbContext>()
            .UseSqlServer(connectionString)
            .Options;
        var context = new Arcade2048DbContext(options, null, null, null);
